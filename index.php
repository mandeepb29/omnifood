...
<html lang="en">
    ...
    <body>
        <header>
            <nav>
                <div class="row">
                    <img src="resources/img/logo-white.png" alt="Omnifood logo" class="logo js--go-top-btn">
                    <img src="resources/img/logo.png" alt="Omnifood logo" class="logo-black js--go-top-btn">
